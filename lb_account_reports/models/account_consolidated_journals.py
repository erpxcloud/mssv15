    ...
    def _get_lines(self, options, line_id=None):
        ...
        if options.get('selected_multi_currency'):
            ...
            if selected_multi_currency == company.second_currency_id.id:
                select = select.replace('.debit', '.second_debit').replace('.credit', '.second_credit').replace('.balance', '.second_balance')
            elif selected_multi_currency == company.third_currency_id.id:
               select = select.replace('.debit', '.third_debit').replace('.credit', '.third_credit').replace('.balance', '.third_balance')
